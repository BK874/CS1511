...
\section*{54}
The final state works by mapping the two classical particles $z_0,z_1$ to indicate the quadrant that the Bell measurement of $a,x$ ends up in. Then the rotation from $b$ to the quadrant indicated by $z_0,z_1$ is measured. Finally, that difference in rotation is added to $b$ to make a qubit identical to $x$.
\\\\
